    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl w-full z-10">
        ...
        <div>
          ...
          <motion.p
            {...fadeUp(0.2)}
            className="text-slate-400 text-lg font-medium mt-4"
          >
            ⚡ Frontend Developer
          </motion.p>
          ...
          <motion.p
            {...fadeUp(0.3)}
            className="text-slate-400 leading-relaxed mt-3 max-w-[480px]"
          >
            I craft <strong className="text-black">pixel-perfect</strong>,
            performant web interfaces that users love — turning creative designs
            into fast, accessible, and beautiful digital experiences.
          </motion.p>
...
<a
  href="#contact"
  className="relative inline-flex items-center gap-2 px-8 py-3.5 rounded-xl font-semibold 
  border border-cyan-400/40 text-gray-700 overflow-hidden
  transition-all duration-500 ease-out delay-150
  hover:-translate-y-0.5 hover:text-white hover:border-cyan-400
  hover:bg-[linear-gradient(135deg,#06b6d4,#3b82f6)]"
>
  {/* Gradient Layer */}
        ...
        >
          <div className="relative w-[320px] h-[320px]">
            ...
            <div
              ...
              style={{
                background:
                  "conic-gradient(from 0deg,#38bdf8,#3b82f6,#818cf8,#38bdf8)",
                padding: 2,
              }}
            >
              <div
            ...
            {/* Inner circle */}
            <div
              className="absolute inset-4 rounded-full flex items-center justify-center border overflow-hidden"
              style={{
            ...
            {/* Floating chips */}
            <div
              className="absolute -right-6 top-6 flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold border animate-chip"
              style={{
                background: "#111827",
                color: "white",
                borderColor: "rgba(99,179,237,0.12)",
                boxShadow: "0 0 30px rgba(222, 222, 222, 0.1)",
              }}
            >
              ⚛️ React Dev
            </div>
            <div
              className="absolute -left-8 bottom-10 flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold border"
              style={{
                background: "#111827",
                color: "white",
                borderColor: "rgba(99,179,237,0.12)",
